...
import { X, ChevronLeft, ChevronRight, MapPin, Phone, User, Lock } from 'lucide-react';
                ...
                <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="flex items-center text-gray-600">
                      ...
                      <span>{field.ownerName || translations.ownerNotSpecified}</span>
                    </div>
                    
                    {isLoggedIn ? (
                      <div className="flex items-center text-gray-600">
                        <Phone className="h-5 w-5 mr-2 text-green-600" />
                        <a href={`tel:${field.phone}`} className="hover:text-green-600 font-semibold">
                          {field.phone}
                        </a>
                      </div>
                    ) : (
                      <div className="flex items-center text-gray-600 bg-slate-50 border border-slate-200 rounded-2xl p-3 sm:col-span-2">
                        ...
                        <div className="text-left">
                          ...
                          <button 
                            ...
                            className="text-sm font-semibold text-brand-600 hover:text-brand-700 hover:underline mt-0.5"
                          >
